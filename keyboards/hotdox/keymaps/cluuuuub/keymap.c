 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L2  |  '"  |AltShf| Left | Down |                                       |  Up  | Right|   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | LGui |       | Alt  |  Esc |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        TG(MDIA),              KC_QUOT,  LALT(KC_LSFT),  KC_LEFT,  KC_DOWN,
...
[SYMB] = LAYOUT_ergodox(
       ...
       EEP_RST,KC_COMM,KC_DOT ,KC_TRNS,KC_TRNS,
                                       KC_TRNS,KC_TRNS,
                                               KC_TRNS,
 ...
 * |        |      |      |      |      |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | -L2  |      |      |      |Wheelu|                                       |Wheeld|VolUp |VolDn |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
 *                                 |      |      |      |       |      |      |      |
 *                                 | Lclk | Rclk |------|       |------| Mbtn4| Mbtn5|
 *                                 |      |      | Mclk |       |      |      |      |
 *                                 `--------------------'       `--------------------'
 */
// MEDIA AND MOUSE
[MDIA] = LAYOUT_ergodox(
       ...
       KC_NO  ,    KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
       TG(MDIA)  , KC_NO  , KC_NO  , KC_NO  , KC_WH_U,
                                           KC_NO  , KC_NO  ,
                                                    KC_NO  ,
    ...
    // right hand
       ...
       KC_NO  ,  KC_NO  , KC_NO  , KC_MPRV, KC_MNXT, KC_NO  , KC_NO  ,
                          KC_WH_D, KC_VOLU, KC_VOLD,  KC_NO  , KC_NO  ,
       KC_NO  , KC_NO  ,
       KC_NO  ,
       KC_NO  , KC_BTN4, KC_BTN5
),
};
