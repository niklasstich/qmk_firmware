 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LGUI   | LALT   | FN     | SPACE  | BACKSP | LEFT   | DOWN   | RIGHT  |  DEL   | ENTER  | FN     | RALT   | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
  ...
  [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_SPC,  KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_ENT,  MO(_FN), KC_RALT, KC_RGUI, KC_RCTL
  ),
